...
export default function Header (){
    return(
      ...
      <div className='flex flex-wrap items-center gap-4 w-full max-w-6x1 mx-auto'>
        <a href="javascript:void(0)"><img src="https://static.wixstatic.com/media/cf6c1c_80e509b78c324d2aa3558b864231438b~mv2.png/v1/fit/w_2500,h_1330,al_c/cf6c1c_80e509b78c324d2aa3558b864231438b~mv2.png" alt="logo" className='w-36' />
        </a>
        ...
        <li>
          <Link href='MoreItems'>MoreItems</Link>
        </li>
        <li>
          <Link href='Team'>Service</Link>
        </li>
        <li>
            ...
            <ul className='lg:flex lg:items-center ml-auto max-lg:block lg:space-x-8'>
              <li className='max-lg:border-b max-lg:py-3 max-lg:mt-2'>
                <a href='javascript:void(0)'
                  className='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Pricing</a>
              </li>
              <li className='max-lg:border-b max-lg:py-3 max-lg:mt-2'><a href='javascript:void(0)'
                className='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Learn</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className='flex items-center ml-auto space-x-6'>
          <a href='javascript:void(0)' className='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Log
            in</a>
          <button
            className='px-4 py-2 text-sm rounded font-semibold text-white border-2 border-[#1d294f] bg-[#1d294f] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#1d294f]'>Start
            free trial</button>
